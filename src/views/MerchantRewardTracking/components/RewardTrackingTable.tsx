...
const MerchantRewardTrackingTable = () => {
    ...
    const loading = useAppSelector(
        (state) => state.merchantRewardTracking.data.loading,
    )
        ...
        () => [
            {
                ...
                cell: (props) => {
                    ...
                    return (
                        <p
                            className={`${priorityConfig[priority_level]?.bgColor} px-5 py-2 rounded-lg text-white`}
                        >
                            {priorityConfig[priority_level]?.label}
                        </p>
                    )
                },
            },
