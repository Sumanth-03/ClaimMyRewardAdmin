...
import { apiGetChat, apipostMessage } from '@/services/AdditionalServices'
import { apiCampaignResolveTicket } from '@/services/CampaignRewardTrackingService'
...
>(SLICE_NAME + '/postCampaignResolve', async (data, { rejectWithValue }) => {
    try {
...
export const { resetState } = campaignDetailSlice.actions
