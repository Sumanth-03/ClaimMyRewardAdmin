...
import { useAppSelector as useAppSelectorTable } from '../CampaignRewardTracking/store'
...
const CampaignRewardTrackingDetailsPage = () => {
    ...
    function findObjectById(
        Id: String,
        array: CampaignRewardTrackingData[],
    ): CampaignRewardTrackingData | undefined {
    ...
    const handlePostMessage = async (message: String, Id?: String) => {
        ...
        try {
            dispatch(
                postMessage({ ticket_id: Number(Id), msg: message, type: 2 }),
            )
        } catch (error) {
