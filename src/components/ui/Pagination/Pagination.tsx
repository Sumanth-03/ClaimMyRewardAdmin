...
const Pagination = (props: PaginationProps) => {
    ...
    const getValidCurrentPage = useCallback(
        (count: number | string) => {
            ...
            const internalPageCount = 10000 //to avoid total page count
            let resetValue
    ...
    const pagerClass = {
        ...
        active: `text-white bg-${themeColor}-50 hover:bg-${themeColor}-50 dark:bg-${themeColor}-${primaryColorLevel} dark:text-gray-100`,
    ...
    return (
        <div className={paginationClass}>
            ...
            />
            <Pager
                // pageCount={getInternalPageCount as number} // to avoid total page count
                pageCount={internalCurrentPage}
                currentPage={internalCurrentPage}
                pagerClass={pagerClass}
